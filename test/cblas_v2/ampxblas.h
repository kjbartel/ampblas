...
// ampblas_xdot
// uses non-conjugate version as default complex overload
...
template <>                 inline ampblas_fcomplex ampblas_xdot(const int N, const ampblas_fcomplex *X, const int incX, const ampblas_fcomplex *Y, const int incY) { ampblas_fcomplex ret; ampblas_cdotu_sub(N, X, incX, Y, incY, &ret); return ret; }
template <>                 inline ampblas_dcomplex ampblas_xdot(const int N, const ampblas_dcomplex *X, const int incX, const ampblas_dcomplex *Y, const int incY) { ampblas_dcomplex ret; ampblas_zdotu_sub(N, X, incX, Y, incY, &ret); return ret; }
...
template <>             inline void ampblas_xger( enum AMPBLAS_ORDER Order, int M, int N, ampblas_fcomplex alpha, const ampblas_fcomplex* X, int incX, const ampblas_fcomplex* Y, int incY, ampblas_fcomplex* A, int lda ) { ampblas_cgeru( Order, M, N, &alpha, X, incX, Y, incY, A, lda ); }
template <>             inline void ampblas_xger( enum AMPBLAS_ORDER Order, int M, int N, ampblas_dcomplex alpha, const ampblas_dcomplex* X, int incX, const ampblas_dcomplex* Y, int incY, ampblas_dcomplex* A, int lda ) { ampblas_zgeru( Order, M, N, &alpha, X, incX, Y, incY, A, lda ); }
...
// ampblas_xsyr
template <typename value_type> void ampblas_xsyr( enum AMPBLAS_ORDER Order, enum AMPBLAS_UPLO UPLO, int N, value_type alpha, const value_type* X, int incX, value_type* A, int lda );
...
template <>             inline void ampblas_xsymm(const enum AMPBLAS_ORDER Order, const enum AMPBLAS_SIDE Side, const enum AMPBLAS_UPLO Uplo, const int M, const int N, const ampblas_fcomplex alpha, const ampblas_fcomplex *A, const int lda, const ampblas_fcomplex *B, const int ldb, const ampblas_fcomplex beta, ampblas_fcomplex *C, const int ldc) { ampblas_csymm(Order, Side, Uplo, M, N, &alpha, A, lda, B, ldb, &beta, C, ldc); }
template <>             inline void ampblas_xsymm(const enum AMPBLAS_ORDER Order, const enum AMPBLAS_SIDE Side, const enum AMPBLAS_UPLO Uplo, const int M, const int N, const ampblas_dcomplex alpha, const ampblas_dcomplex *A, const int lda, const ampblas_dcomplex *B, const int ldb, const ampblas_dcomplex beta, ampblas_dcomplex *C, const int ldc) { ampblas_zsymm(Order, Side, Uplo, M, N, &alpha, A, lda, B, ldb, &beta, C, ldc); }

// ampblas_xsyrk
template <typename value_type> void ampblas_xsyrk(const enum AMPBLAS_ORDER Order, const enum AMPBLAS_UPLO Uplo, const enum AMPBLAS_TRANSPOSE Trans, const int N, const int K, const value_type       alpha, const value_type       *A, const int lda, const value_type       beta, value_type       *C, const int ldc);
...
template <>             inline void ampblas_xsyrk(const enum AMPBLAS_ORDER Order, const enum AMPBLAS_UPLO Uplo, const enum AMPBLAS_TRANSPOSE Trans, const int N, const int K, const ampblas_fcomplex alpha, const ampblas_fcomplex *A, const int lda, const ampblas_fcomplex beta, ampblas_fcomplex *C, const int ldc) { ampblas_csyrk(Order, Uplo, Trans, N, K, &alpha, A, lda, &beta, C, ldc); }
template <>             inline void ampblas_xsyrk(const enum AMPBLAS_ORDER Order, const enum AMPBLAS_UPLO Uplo, const enum AMPBLAS_TRANSPOSE Trans, const int N, const int K, const ampblas_dcomplex alpha, const ampblas_dcomplex *A, const int lda, const ampblas_dcomplex beta, ampblas_dcomplex *C, const int ldc) { ampblas_zsyrk(Order, Uplo, Trans, N, K, &alpha, A, lda, &beta, C, ldc); }

// ampblas_syrk2k
template <typename value_type> void ampblas_xsyr2k(const enum AMPBLAS_ORDER Order, const enum AMPBLAS_UPLO Uplo, const enum AMPBLAS_TRANSPOSE Trans, const int N, const int K, const value_type       alpha, const value_type       *A, const int lda, const value_type       *B, const int ldb, const value_type       beta, value_type       *C, const int ldc);
...
template <>             inline void ampblas_xsyr2k(const enum AMPBLAS_ORDER Order, const enum AMPBLAS_UPLO Uplo, const enum AMPBLAS_TRANSPOSE Trans, const int N, const int K, const ampblas_fcomplex alpha, const ampblas_fcomplex *A, const int lda, const ampblas_fcomplex *B, const int ldb, const ampblas_fcomplex beta, ampblas_fcomplex *C, const int ldc) { ampblas_csyr2k(Order, Uplo, Trans, N, K, &alpha, A, lda, B, ldb, &beta, C, ldc); }
template <>             inline void ampblas_xsyr2k(const enum AMPBLAS_ORDER Order, const enum AMPBLAS_UPLO Uplo, const enum AMPBLAS_TRANSPOSE Trans, const int N, const int K, const ampblas_dcomplex alpha, const ampblas_dcomplex *A, const int lda, const ampblas_dcomplex *B, const int ldb, const ampblas_dcomplex beta, ampblas_dcomplex *C, const int ldc) { ampblas_zsyr2k(Order, Uplo, Trans, N, K, &alpha, A, lda, B, ldb, &beta, C, ldc); }
